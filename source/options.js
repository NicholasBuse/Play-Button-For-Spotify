...
document.getElementById('page').options[1].text = chrome.i18n.getMessage('page_featured');
document.getElementById('page').options[2].text = chrome.i18n.getMessage('page_podcasts');
document.getElementById('page').options[3].text = chrome.i18n.getMessage('page_generes');
document.getElementById('page').options[4].text = chrome.i18n.getMessage('page_new_releases');
document.getElementById('page').options[5].text = chrome.i18n.getMessage('page_discover');
document.getElementById('page').options[6].text = chrome.i18n.getMessage('page_playlists');
document.getElementById('page').options[7].text = chrome.i18n.getMessage('page_mix');
document.getElementById('page').options[8].text = chrome.i18n.getMessage('page_songs');
document.getElementById('page').options[9].text = chrome.i18n.getMessage('page_albums');
document.getElementById('page').options[10].text = chrome.i18n.getMessage('page_artists');
document.getElementById('page').options[11].text = chrome.i18n.getMessage('page_none');
